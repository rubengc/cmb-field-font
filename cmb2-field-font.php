...
if( !class_exists( 'CMB2_Field_Font' ) ) {
    ...
    class CMB2_Field_Font {
        ...
        public function setup_admin_scripts() {
            ...
            wp_register_script( 'cmb-font-webfont', plugins_url( 'js/webfont.js', __FILE__ ), array( 'jquery' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-font-webfont' );

            // https://select2.org/
            wp_register_script( 'cmb-font-select2', plugins_url( 'js/select2.full.min.js', __FILE__ ), array( 'jquery' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-font-select2' );

            wp_enqueue_style( 'cmb-font-select2', plugins_url( 'css/select2.min.css', __FILE__ ), array(), self::VERSION );
            ...
            wp_register_script( 'cmb-font-higooglefonts', plugins_url( 'js/higooglefonts.js', __FILE__ ), array( 'jquery', 'cmb-font-webfont', 'cmb-font-select2' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-font-higooglefonts' );

            wp_register_script( 'cmb-field-font', plugins_url( 'js/font.js', __FILE__ ), array( 'jquery' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-field-font' );

            wp_enqueue_style( 'cmb-field-font', plugins_url( 'css/font.css', __FILE__ ), array(), self::VERSION );
